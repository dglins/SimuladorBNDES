...
prazo_amortizacao = st.number_input("Prazo de Amortização (meses)", min_value=1, value=24)
periodic_amortizacao = st.number_input("Periodicidade do Pagamento de Amortização (meses)", min_value=1, value=1)
